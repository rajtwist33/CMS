            ...
            <li>
                <div class="media">
                    <div class="notification-img bg-light-primary"><img
                            src="{{ asset('backend/assets/images/avtar/man.png') }}" alt="">
                    </div>
            ...
            <li>
                <div class="media">
                    <div class="notification-img bg-light-secondary"><img
                            src="{{ asset('backend/assets/images/avtar/teacher.png') }}" alt=""></div>
                    <div class="media-body">
            ...
            <li>
                <div class="media">
                    <div class="notification-img bg-light-info"><img
                            src="{{ asset('backend/assets/images/avtar/teenager.png') }}" alt=""></div>
                    <div class="media-body">
            ...
            <li>
                <div class="media">
                    <div class="notification-img bg-light-success"><img
                            src="{{ asset('backend/assets/images/avtar/chinese.png') }}" alt=""></div>
                    <div class="media-body">
